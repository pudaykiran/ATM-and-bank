...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to Vinay International Bank")
        p1 = PhotoImage(file='./Images/vinay.png')
        window.iconphoto(True, p1)
        window.configure(background="#fafcfc")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#bf884d", borderwidth="0", insertbackground="black",
                                 relief="ridge",
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="#000000", background="#000508", disabledforeground="#a3a3a3",
        ...
        self.Label1 = tk.Label(self.Canvas1, background="#4540c9",disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 13 -weight bold", foreground="#e1e1e3",
...
class Error:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Error")
        window.configure(background="#f2f4f4")
...
class adminLogin:
    def __init__(self, window=None):
        ...
        global Canvas1
        Canvas1 = tk.Canvas(window, background="#808080", insertbackground="black", relief="ridge",
                            selectbackground="blue", selectforeground="white")
        Canvas1.place(relx=0.108, rely=0.142, relheight=0.715, relwidth=0.798)

        self.Label1 = tk.Label(Canvas1, background="#808080", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 14 -weight bold", foreground="#00254a",
                               text="Admin Login")
        self.Label1.place(relx=0.135, rely=0.142, height=41, width=154)

        global Label2
        Label2 = tk.Label(Canvas1, background="#808080", disabledforeground="#a3a3a3", foreground="#000000")
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        window.configure(background="#513B1C")

        global Canvas1
        Canvas1 = tk.Canvas(window, background="#ffffff", insertbackground="white", relief="ridge",
                            selectbackground="black", selectforeground="blue")
        Canvas1.place(relx=0.108, rely=0.142, relheight=0.715, relwidth=0.798)
...
class adminMenu:
    def __init__(self, window=None):
        ...
        window.configure(background="#4E5180")
